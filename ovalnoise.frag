...
uniform float uAd = 0.1f;
uniform float uBd = 0.1f;
uniform float uNoiseAmp = 100.0f;
uniform float uNoiseFreq = 1.0f;
uniform float uAlpha = 1.0f;
uniform float uTol = 0.0f;
uniform bool uUseChromaDepth = false;
uniform float uChromaBlue = -1.0f;
uniform float uChromaRed = 1.0f;
